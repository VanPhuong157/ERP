...
export default function PersonalEmployeeDashboard({
  ...
  const [filter, setFilter] = useState(() => {
    ...
    // Hàm đảm bảo lấy đúng ngày tháng năm theo máy tính người dùng
  ...
  const kpiChartData = [
    ...
    {
      name: "Trung bình (31-50%)",
      value: data?.sectionKPI?.completedAverage || 0,
      color: "#f59e0b",
    },
    {
      name: "Cảnh báo (≤30%)",
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm border-l-4 border-l-orange-500">
              ...
              <p className="text-3xl font-black text-orange-500 mt-1">
                {data?.sectionKPI?.completedAverage || 0}
              </p>
            </div>
              ...
              <table className="w-full text-left border-collapse text-sm">
                ...
                <tbody>
                  ...
                  <tr className="border-b bg-orange-50/30 font-bold text-orange-700">
                    ...
                    <td className="p-4 text-center">
                      {calculatePercent(
                        data?.sectionKPI?.completedAverage,
                        totalKPI,
                      )}
                      %
                    </td>
